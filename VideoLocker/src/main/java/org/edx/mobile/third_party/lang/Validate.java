package org.edx.mobile.third_party.lang;

/*
 * This class has been copied from the Apache Commons Lang project, and
 * modified to link only to the other copied utility classes in the same
 * package. Methods that referenced other utility classes that are not
 * present in the package have either been modified to work without them,
 * or removed entirely. Since it's only for available for use by the other
 * copied utility classes in the same package, so it's been made package-
 * private.
 *
...
class Validate {
     ...
     * @see #greaterObj(Comparable, Object, String, Object...)
     *
     * @since 3.5
     */
     ...
     * @param values  the optional values for the formatted exception message
     * @throws IllegalArgumentException if {@code value} is smaller than or equal to {@code min}
     * @see #greaterObj(Comparable, Object)
     *
     * @since 3.5
     */
     ...
     * @param min  the reference value
     * @throws IllegalArgumentException if {@code value} is smaller than or equal to {@code min}
     * @see #greater(long, long, String, Object...)
     *
     * @since 3.5
     */
     ...
     * @param min  the reference value
     * @throws IllegalArgumentException if {@code value} is smaller than or equal to {@code min}
     * @see #greater(double, double, String, Object...)
     *
     * @since 3.5
     */
     ...
     * @see #greaterOrEqualObj(Comparable, Object, String, Object...)
     *
     * @since 3.5
     */
     ...
     * @param values  the optional values for the formatted exception message
     * @throws IllegalArgumentException if {@code value} is smaller than {@code min}
     * @see #greaterOrEqualObj(Comparable, Object)
     *
     * @since 3.5
     */
     ...
     * @param min  the reference value
     * @throws IllegalArgumentException if {@code value} is smaller than {@code min}
     * @see #greaterOrEqual(long, long, String, Object...)
     *
     * @since 3.5
     */
     ...
     * @param min  the reference value
     * @throws IllegalArgumentException if {@code value} is smaller than {@code min}
     * @see #greaterOrEqual(double, double, String, Object...)
     *
     * @since 3.5
     */
     ...
     * @see #smallerObj(Comparable, Object, String, Object...)
     *
     * @since 3.5
     */
     ...
     * @param values  the optional values for the formatted exception message
     * @throws IllegalArgumentException if {@code value} is greater than or equal to {@code max}
     * @see #smallerObj(Comparable, Object)
     *
     * @since 3.5
     */
     ...
     * @param max  the reference value
     * @throws IllegalArgumentException if {@code value} is greater than or equal to {@code max}
     * @see #smaller(long, long, String, Object...)
     *
     * @since 3.5
     */
     ...
     * @param max  the reference value
     * @throws IllegalArgumentException if {@code value} is greater than or equal to {@code max}
     * @see #smaller(double, double, String, Object...)
     *
     * @since 3.5
     */
     ...
     * @see #smallerOrEqualObj(Comparable, Object, String, Object...)
     *
     * @since 3.5
     */
     ...
     * @param values  the optional values for the formatted exception message
     * @throws IllegalArgumentException if {@code value} is greater than {@code max}
     * @see #smallerOrEqualObj(Comparable, Object)
     *
     * @since 3.5
     */
     ...
     * @param max  the reference value
     * @throws IllegalArgumentException if {@code value} is greater than {@code max}
     * @see #smallerOrEqual(long, long, String, Object...)
     *
     * @since 3.5
     */
     ...
     * @param max  the reference value
     * @throws IllegalArgumentException if {@code value} is greater than {@code max}
     * @see #smallerOrEqual(double, double, String, Object...)
     *
     * @since 3.5
     */
